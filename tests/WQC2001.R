...
plot(x.eval, Lambda(x.eval), type="l", xlab="x", ylab="Lambda.hat", 
...
legend("bottomright", c("Lambda.hat", "Lambda", "asymptotic pointwise C.I.", "bootstrap pointwise C.I."), lty=c(1, 1, 2, 2), col=c(1, 3, 1, 2), lwd=c(1, 2, 1, 1))
